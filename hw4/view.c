...
char *fileName(int fileIdx) {
        switch (fileIdx) {
                case 0:
                        return "images/regular/state0/blue.png";
                case 1:
                        return "images/regular/state0/green.png";
                case 2:
                        return "images/regular/state0/orange.png";
                case 3:
                        return "images/regular/state0/purple.png";
                case 4:
                        return "images/regular/state0/red.png";
                case 5:
                        return "images/regular/state0/yellow.png";
                default:
			return "images/regular/state0/nocolor.png";
        }
	return (char*)-1;
}
        ...
        for (int j = 0; j < num_cols; j++) {
	 	...
	 	if (cell != NULL) {
			gtk_container_remove (GTK_CONTAINER (grid), cell);
                ...
                /* create toggle button and init with image */
                GtkWidget *imageButton = gtk_toggle_button_new();
                int image_val = (intptr_t)Array2d_get(model->image_vals, i, j);
